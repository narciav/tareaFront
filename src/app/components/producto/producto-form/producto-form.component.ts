  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes["producto"] && this.producto) {
      this.form.patchValue({
        ...this.producto,
        id:
          this.producto.id !== undefined && this.producto.id !== null
            ? String(this.producto.id)
            : null,
        categoriaId:
          this.producto.categoriaId !== undefined &&
          this.producto.categoriaId !== null
            ? String(this.producto.categoriaId)
            : null,
        precio:
          this.producto.precio !== undefined && this.producto.precio !== null
            ? String(this.producto.precio)
            : null,
        cantidad:
          this.producto.cantidad !== undefined &&
          this.producto.cantidad !== null
            ? String(this.producto.cantidad)
            : null,
      });
